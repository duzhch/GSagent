...
| `F-P0-02-01` | `AC-P0-02-02` | `TC-P0-02-02` | E2E | `tests/e2e/p0_qc_blocking.md` | QA | PASS |
| `F-P0-02-01` | `AC-P0-02-03` | `TC-P0-02-03` | Risk | `tests/risk/p0_override_audit.md` | QA | PASS |
| `F-P0-02-02` | `AC-P0-02-04` | `TC-P0-02-04` | IT | `tests/integration/p0_population_structure.md` | Dev+QA | PASS |
| `F-P0-02-02` | `AC-P0-02-05` | `TC-P0-02-05` | Risk | `tests/risk/p0_structure_risk_tag.md` | QA | PASS |
| `F-P0-02-03` | `AC-P0-02-06` | `TC-P0-02-06` | IT | `tests/integration/p0_pheno_batch_diagnosis.md` | Dev+QA | PASS |
| `F-P0-02-03` | `AC-P0-02-07` | `TC-P0-02-07` | E2E | `tests/e2e/p0_covariate_recommendation.md` | QA | PASS |
...
| Req ID | AC ID | Test Case ID | Test Type | Evidence | Owner | Coverage Status |
|---|---|---|---|---|---|---|
| `F-P1-01-01` | `AC-P1-01-01` | `TC-P1-01-01` | IT | `tests/integration/p1_knowledge_connector.md` | Dev+QA | PASS |
| `F-P1-01-02` | `AC-P1-01-02` | `TC-P1-01-02` | IT | `tests/integration/p1_retrieval_rerank.md` | QA | PASS |
| `F-P1-01-03` | `AC-P1-01-03` | `TC-P1-01-03` | Risk | `tests/risk/p1_evidence_conflict.md` | QA | PASS |
| `F-P1-02-01` | `AC-P1-02-01` | `TC-P1-02-01` | UT | `tests/unit/p1_badcase_schema.py` | Dev | PASS |
| `F-P1-02-02` | `AC-P1-02-02` | `TC-P1-02-02` | IT | `tests/integration/p1_badcase_similarity.md` | QA | PASS |
| `F-P1-02-03` | `AC-P1-02-03` | `TC-P1-02-03` | E2E | `tests/e2e/p1_preventive_actions.md` | QA | PASS |
| `F-P1-03-01` | `AC-P1-03-01` | `TC-P1-03-01` | IT | `tests/integration/p1_technical_report.md` | Dev+QA | PASS |
| `F-P1-03-02` | `AC-P1-03-02` | `TC-P1-03-02` | IT | `tests/integration/p1_decision_report.md` | QA | PASS |
| `F-P1-03-03` | `AC-P1-03-03` | `TC-P1-03-03` | IT | `tests/integration/p1_management_report.md` | QA | PASS |
...
| `F-P1-04-03` | `AC-P1-04-03` | `TC-P1-04-03` | E2E | `tests/e2e/p1_abort_and_fallback.md` | QA | PASS |

## 4. P2 追踪矩阵

| Req ID | AC ID | Test Case ID | Test Type | Evidence | Owner | Coverage Status |
|---|---|---|---|---|---|---|
| `F-P2-01-01` | `AC-P2-01-01` | `TC-P2-01-01` | IT | `tests/integration/p2_baseline_bench.md` | Dev+QA | PASS |
| `F-P2-01-02` | `AC-P2-01-02` | `TC-P2-01-02` | IT | `tests/integration/p2_ablation_bench.md` | QA | PASS |
| `F-P2-01-03` | `AC-P2-01-03` | `TC-P2-01-03` | E2E | `tests/e2e/p2_plot_export.md` | QA | PASS |
